...
* [Devops - Sécuriser l'accès à votre gestionnaire de version de codes](https://blog.stephane-robert.info/post/devops-s%C3%A9curit%C3%A9-gestionnaire-version-code/)
* [DevOps - Héberger son sigstore privé pour signer ses artefacts](https://blog.stephane-robert.info/post/devops-cosign-rekor-private/)
* [DevOps - Cosign pour signer vos containers OCI](https://blog.stephane-robert.info/post/devops-sigstore-cosign-slsa/)
* [DevOps - Sécuriser la chaine d'approvisionnement logicielle](https://blog.stephane-robert.info/post/devops-compliance-supply-chain/)
...
## Weather
Unknown location; please try ~50.6305089,3.0706414