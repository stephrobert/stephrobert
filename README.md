...
* [Devops - Gestion de la dette technique de l'infra as code](https://blog.stephane-robert.info/post/devops-dette-technique/)
* [Devops - R2DevOps un outil d'analyse de la sécurité de la supply chain](https://blog.stephane-robert.info/post/devops-r2devops-secure-supply-chain/)
