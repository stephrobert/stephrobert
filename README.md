...
* [Podman Desktop 1.0](https://blog.stephane-robert.info/post/introduction-podman-desktop/)
* [Sécurité - Trivy scanne désormais les clusters Kubernetes](https://blog.stephane-robert.info/post/devops-trivy-cis-kubernetes/)
* [Kubernetes - Premiers pas avec l'operateur Ansible](https://blog.stephane-robert.info/post/ansible-kubernetes-operator/)
* [Ansible - Mon générateur de taches assisté de ChatGPT](https://blog.stephane-robert.info/post/ansible-ia-chatgpt-3/)
