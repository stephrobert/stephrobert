...
* [Glab est devenue la cli officielle de gitlab](https://blog.stephane-robert.info/post/gitlab-cli/)
* [Ansible - Ecrire des rôles pour factoriser votre code](https://blog.stephane-robert.info/post/ansible-ecrire-roles/)
* [Ansible - Générer la documentation de vos roles automatiquement](https://blog.stephane-robert.info/post/ansible-gendoc-role-collection/)
* [Scanner les vulnérabilités de vos conteneurs et filesystem avec grype](https://blog.stephane-robert.info/post/devops-scan-vulnerabilites-conteneurs-grype/)
