...
* [Ansible - les modules assert et validate_argument_spec peuvent tout controler !](https://blog.stephane-robert.info/post/ansible-assert-tests/)
* [Ansible - Mon extension vscode de snippets](https://blog.stephane-robert.info/post/ansible-extension-snippets/)
* [Ansible - Projet Wisdom ajout de l'IA dans l'extension Vscode](https://blog.stephane-robert.info/post/ansible-wisdom-ia/)
* [Ansible - Utiliser le driver delegated de Molecule](https://blog.stephane-robert.info/post/ansible-molecule-delegated-driver-terraform/)
